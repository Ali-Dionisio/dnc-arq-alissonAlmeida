...
// ASSETS
import LinkedFilled from '../../assets/like-filled.svg'
    ...
    const handleSavedProjects = (id) => {
        setFavProject((prevFavProjects) => {
            if (prevFavProjects.includes(id)) {
                const filterArray = 
                     prevFavProjects.filter((projectId) => projectId !== id)
                    ...
                    projects.map((project) => (
                        <div 
                            ...
                            <Button buttonStyle="unstyled" onClick={() => handleSavedProjects(project.id)}>
                                <img src={favProjects.includes(project.id) ? LinkedFilled : LikeOutline}  height="20px"/>
                            </Button>
                        </div>
                    ))
                    : 
